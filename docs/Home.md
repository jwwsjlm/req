...
| 指纹和协议 | [浏览器与 TLS 指纹](10-browser-tls-fingerprint.md)、[HTTP/2 与 HTTP/3](11-http2-http3.md) | coherent profile、协议选择和回退 |
| 长期维护 | [性能与稳定性](12-performance-stability.md)、[迁移与兼容](14-migration-compatibility.md) | 资源边界、兼容原则和升级清单 |
...
- 浏览器伪装优先使用完整 `Impersonate*` profile，而不是只修改 `User-Agent`。
